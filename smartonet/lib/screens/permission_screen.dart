...
//     // Logic này tuỳ biến, ở đây mình gọi request luôn để hiện popup
//     bool granted = await _permissionService.requestCorePermissions();
//     setState(() {
...
//     // Check lại lần cuối trước khi cho vào
//     bool granted = await _permissionService.requestCorePermissions();
...
//       Navigator.of(
//         context,
//       ).pushReplacementNamed('/home'); // Hoặc Navigator.pushReplacement(...)
//     } else {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(
//           content: Text('Vui lòng cấp đủ quyền để báo thức hoạt động ổn định!'),
//         ),
//       );
//     }
//   }
